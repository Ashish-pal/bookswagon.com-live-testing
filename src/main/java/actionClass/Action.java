...
public class Action extends BaseClass {
	...
	public static boolean mouseHoverByJavaScript(WebDriver driver, WebElement element) {
		boolean flag = false;
		try {
	...
	public static boolean slider(WebDriver driver, WebElement element, int x, int y) {
		boolean flag = false;
		try {
	...
	public static String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8080//ScreenShots/" + filename + "_" + dateName + ".png";
